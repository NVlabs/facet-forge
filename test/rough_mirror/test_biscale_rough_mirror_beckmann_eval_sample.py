...
if __name__ == "__main__":
    raise SystemExit(
        run_eval_sample_cli(
            ...
            title="Biscale rough mirror Beckmann eval/sample",
            specs=[
                float_arg("rough_x", 0.8, "x roughness at each scale"),
                float_arg("rough_y", 0.8, "y roughness at each scale"),
                float_arg("theta_i", 0.1, "incident polar angle in radians"),
