...
if __name__ == "__main__":
    raise SystemExit(
        run_eval_sample_cli(
            ...
            specs=[
                float_arg("rough_x", 0.6, "x roughness"),
                float_arg("rough_y", 1.6, "y roughness"),
                float_arg("theta_i", 2.1, "incident polar angle in radians"),
                float_arg("phi", 0.2, "incident azimuth in radians"),
